...
instr3 = "During the task, you will be allowed to perform one of two actions with the trackball:\n" \
         "    -   roll up (towards your head), or \n" \
         "    -   roll down (towards your feet)\n\n" \
...
instr4a = "When you see this figure, you will be allowed to respond by rolling the trackball down (toward your feet).\n\n" \
         "Try moving the mouse down to mimic this action."
instr_4a_txt = visual.TextStim(
    win=win, name='instr_4a_txt',
    text=instr4a,
    font='Arial', alignText='left',
    pos=(0, 0.1), height=0.06, wrapWidth=0.65*wh_ratio, ori=0,
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0);
...
instr_4b_txt = visual.TextStim(
    ...
    text=instr4b,
    font='Arial', alignText='left',
    pos=(0, -0.3), height=0.06, wrapWidth=0.65*wh_ratio, ori=0,
    color='black', colorSpace='rgb', opacity=1,
    depth=-1.0);
stim1_img = visual.ImageStim(
    win=win, name='stim1_img',
    image='stim' + os.sep + 'up_resp_img.png', mask=None,
    ori=0, pos=(0, 0.25), size=(0.18, 0.18), units='height',
    color=[1, 1, 1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-2.0)
...
instr5a = "When you see this figure, you will be allowed to respond by rolling the trackball up (toward your head).\n\n" \
         "Try moving the mouse up to mimic this action."
instr_5a_txt = visual.TextStim(
    win=win, name='instr_5a_txt',
    text=instr5a,
    font='Arial', alignText='left',
    pos=(0, 0.2), height=0.06, wrapWidth=0.65*wh_ratio, ori=0,
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0);
...
stim2_img = visual.ImageStim(
    ...
    image='stim' + os.sep + 'down_resp_img.png', mask=None,
    ori=0, pos=(0, -0.25), size=(0.18, 0.18), units='height',
    color=[1, 1, 1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-2.0)
...
instr6 = "Your trackball actions will *sometimes* be rewarded with a coin (either silver or gold).\n\n" \
         "IMPORTANT: One of the actions (eg., up) will give you gold coins when you are rewarded; the other action (eg., down) will give you silver coins when you are rewarded.\n" \
...
instr10 = "During the FREE COLLECTION phase of the experiment, you will be given 15 seconds to press the buttons beside the trackball to select up to 10 coins from the screen.\n\n" \
         "The button closer to your head will select coins near the top of the screen, and the button closer to your feet will select coins near the bottom of the screen.\n" \
