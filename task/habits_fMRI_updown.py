...
expInfo = {'n_repeat_training': nRepeat,
           ...
           'min_trial_duration': min_trial_duration, 'max_trial_duration': max_trial_duration,
           'schedule': 'RR', 'participant': subj_id, 'task_ordering': 1,   # 'age': 18, 'gender': 'm', 'ethnicity': '',
           'hand': 'right'
           }
...
run1_duration = float(fixed_durations['training_ready'] +\
    ...
    fixed_durations['instr_before_consumption_test'] + fixed_durations['consumption'] + fixed_durations[
...
def resp_made(resp):
    ...
    if phase == "practice":
        ...
        trialLoop.addData("event", "training resp")
        ...
        if resp in [corrResp1, corrResp2]:
            ...
            # record resp and resp time for csv
            blockLoop.addData("event", "consumption resp")
        ...
        if resp in [corrResp1, corrResp2]:
            ...
            # record resp and resp time for csv
            choice_trialLoop.addData("event", "choice resp")
        ...
        if resp in [corrResp]:
            credits += float(expInfo['credits_per_rnf'])
        # record resp and resp time for csv
        contingency_trialLoop.addData("event", "contingency resp")
...
instr_down_txt = visual.TextStim(
    win=win, name='instr_down_txt',
    text="For this figure, you may roll the trackball DOWN.\n\n"
         "Try it a few times!",
    font='Arial', alignText='center',
    pos=(0, 0), height=0.1, wrapWidth=0.95*wh_ratio, ori=0,
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0)
instr_up_txt = visual.TextStim(
    win=win, name='instr_up_txt',
    text="For this figure, you may roll the trackball UP.\n\n"
         "Try it a few times!",
    font='Arial', alignText='center',
    pos=(0, 0), height=0.1, wrapWidth=0.95*wh_ratio, ori=0,
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0)
instr_buttonup_txt = visual.TextStim(
    win=win, name='instr_buttonup_txt',
    text="Try collecting the top 2 coins by clicking the upper trackball button.",
    font='Arial', alignText='center',
    pos=(0, 0), height=0.1, wrapWidth=0.7*wh_ratio, ori=0,
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0)
instr_buttondown_txt = visual.TextStim(
    win=win, name='instr_buttondown_txt',
    text="Now collect the bottom 2 coins by clicking the lower trackball button.",
    font='Arial', alignText='center',
    pos=(0, 0), height=0.1, wrapWidth=0.7*wh_ratio, ori=0,
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0)
...
blue1 = visual.ImageStim(
    ...
    ori=0, pos=(0.1 * wh_ratio, 0.2), size=(0.15, 0.15), units='height',
...
blue2 = visual.ImageStim(
    win=win, name='gold1',
    image='stim' + os.sep + 'blue_coin.png', mask=None,
    ori=0, pos=(-0.25 * wh_ratio, 0.3), size=(0.15, 0.15), units='height',
    color=[1, 1, 1], colorSpace='rgb', opacity=1.0,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-1.0)
blue3 = visual.ImageStim(
    win=win, name='gold1',
    image='stim' + os.sep + 'blue_coin.png', mask=None,
    ori=0, pos=(-0.2 * wh_ratio, -0.25), size=(0.15, 0.15), units='height',
    color=[1, 1, 1], colorSpace='rgb', opacity=1.0,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-1.0)
blue4 = visual.ImageStim(
    win=win, name='gold1',
    image='stim' + os.sep + 'blue_coin.png', mask=None,
    ori=0, pos=(0.15 * wh_ratio, -0.35), size=(0.15, 0.15), units='height',
    color=[1, 1, 1], colorSpace='rgb', opacity=1.0,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-1.0)
...
stim = visual.ImageStim(
    win=win, name='stim',
    image='sin', mask=None,
    ori=0, pos=[0, 0], size=(0.18, 0.18), units='height',
...
free_collection_txt = visual.TextStim(
    ...
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0)
instr_consumption = "Use the buttons to collect 10 coins from the top or bottom of the screen.\n\n" \
...
top_positions = [(-0.1 * wh_ratio, 0.1),
                 (-0.35 * wh_ratio, 0.1),
                 (0.35 * wh_ratio, 0.35),
                 (0 * wh_ratio, 0.3),
                 (-0.25 * wh_ratio, 0.2),
                 ...
                 (0.15 * wh_ratio, 0.1),
                 (-0.15 * wh_ratio, 0.35)]
bottom_positions = [(0.05 * wh_ratio, -0.3),
                    (-0.3 * wh_ratio, -0.15),
                    (-0.05 * wh_ratio, -0.1),
                    (0.225 * wh_ratio, -0.35),
                    (-0.1 * wh_ratio, -0.3),
                    ...
                    (0.3 * wh_ratio, -0.1),
                    (0.4 * wh_ratio, -0.3)]
shuffle(top_positions)
shuffle(bottom_positions)
...
curtain_txt = visual.TextStim(
    ...
    text="CURTAIN",
    font='Arial', alignText='center',
    pos=(0, 0.45), height=0.15, wrapWidth=0.9*wh_ratio, ori=0,
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0)
...
instr_choice_test_txt = visual.TextStim(
    ...
    font='Arial', alignText='left',
    pos=(0, -0.15), height=0.1, wrapWidth=0.8*wh_ratio, ori=0,
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0)
...
for thisTrial in practice_trialLoop:
    ...
    allowed_resp_txt = instr_down_txt if corrResp=="down" else instr_up_txt
    ...
    if practice_trialLoop.thisN == 1:
        ...
        set_components_attr(practice_coins + [instr_buttonup_txt, instr_buttondown_txt], 'status', NOT_STARTED)
        set_components_attr(practice_coins + [instr_buttonup_txt], 'autoDraw', True)
        ...
        while continueRoutine:
            ...
            if all([item==0 for item in prev_buttons]):
                ...
                if buttons[0] and not buttons[2]:
                    ...
                    if len(practice_coins) == 2 and instr_buttondown_txt.status == NOT_STARTED:
                        instr_buttonup_txt.setAutoDraw(False)
                        instr_buttondown_txt.setAutoDraw(True)
                if buttons[2] and not buttons[0]:
                    if 3 > len(practice_coins) > 0:
                        pop_coin = practice_coins.pop(0)
                        pop_coin.setAutoDraw(False)
                    if len(practice_coins) == 0:    # all coins have been collected
                        instr_buttondown_txt.setAutoDraw(False)
                        continueRoutine = False
            prev_buttons = buttons
...
for thisBlock in blockLoop:
    ...
    for thisTrial in trialLoop:
        if trialLoop.thisN==0:
            ...
            show_timed_countdown([training_ready_txt], countdown_msg, routineTimer, win, countdown_t_minus=5)
        ...
        trialLoop.addData("globalClock_t", str(globalClock.getTime()))
        trialLoop.addData("routineClock_t", str(t))
        # trialLoop.addData("trial", trial)
        trialLoop.addData("event", "ITI start")
        ...
        if trialLoop.thisRepN == nTrials - 1 and trialLoop.thisTrialN == len(trialLoop.trialList) - 1:
            show_timed_countdown([ITI_msg, break_msg], None, routineTimer, win, countdown_t_minus=5, bg_rect=black_bg)
        else:
            show_timed_countdown([ITI_msg, break_msg], countdown_msg, routineTimer, win, countdown_t_minus=5, bg_rect=black_bg)
        # -------Ending Routine "ITI"-------
    ...
    if blockLoop.thisTrialN == 0:
        ...
        show_timed_countdown(piggy_bank_partially_fullComponents, None, routineTimer, win)
        ...
        show_timed_countdown(piggy_bank_fullComponents, None, routineTimer, win)
    ...
    show_timed_countdown(instr_before_consumption_testComponents, countdown_msg, routineTimer, win, countdown_t_minus=5)
        ...
        for paramName in thisBlock:
            ...
            if expInfo['hand'] == 'left':
                if paramName in ["corrResp1", "corrResp2"]:
                    exec('{} = key_swap_map[thisBlock[paramName]]'.format(paramName))

    bottom_cointype = outcome_choice1
    # keep track of which components have finished
    if bottom_cointype == 'gold':
        bottom_coins = gold_coins
        top_coins = silver_coins
    else:
        bottom_coins = silver_coins
        top_coins = gold_coins
    delay_start_t = 0
    prev_buttons = mouse.getPressed()
    ...
    while continueRoutine:
        ...
        if t < frameRemains:
            ...
            for idx in range(len(top_coins)):
                component = top_coins[idx]
                if t < frameRemains:
                    if component.status == NOT_STARTED:
                        component.setPos(top_positions[idx])
            ...
            for idx in range(len(bottom_coins)):
                component = bottom_coins[idx]
                if t < frameRemains:
                    if component.status == NOT_STARTED:
                        component.tStart = t
                        component.frameNStart = frameN  # exact frame index
                        component.setPos(bottom_positions[idx])
                        component.setOpacity(1, log=False)
                        component.setAutoDraw(True)
                else:
                    if component.status == STARTED:
            ...
            if len(selected_coins) < 10:
                ...
                if all([item==0 for item in prev_buttons]):
                    ...
                    if up_cnt > down_cnt == 0:
                        if top_coins:
                            selected = top_coins.pop()
                            selected_coins.append(selected)
                            selected.setAutoDraw(False)
                            resp_made('up')
                    elif down_cnt > up_cnt == 0:
                        if bottom_coins:
                            selected = bottom_coins.pop()
                            selected_coins.append(selected)
                            selected.setAutoDraw(False)
                            resp_made('down')
                prev_buttons = buttons
...
for thisTrial in choice_trialLoop:
    ...
    choice_trialLoop.addData("globalClock_t", str(globalClock.getTime()))
    choice_trialLoop.addData("event", "instructions before choice test")
    choice_trialLoop.addData("duration", instr_choice_test_duration)
    thisExp.nextEntry()
    routineTimer.reset(instr_choice_test_duration)  # clock
    show_timed_countdown([curtain_txt, instr_choice_test_txt], countdown_msg, routineTimer, win, countdown_t_minus=5)
